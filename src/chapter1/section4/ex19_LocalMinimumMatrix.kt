 ...
 */
fun ex19b_LocalMinimumMatrix(array: Array<Array<Int>>): Triple<Int, Int, Int> {
    require(array.isNotEmpty() && array[0].isNotEmpty())
    var startX = 0
...
fun main() {
    ...
    //切换不同数据源
    val array = array1
    val tripleA = ex19a_LocalMinimumMatrix(array)
    val tripleB = ex19b_LocalMinimumMatrix(array)
    array.forEach {
