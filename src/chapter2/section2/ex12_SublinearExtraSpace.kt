 ...
 */
fun <T : Comparable<T>> ex12_SublinearExtraSpace(array: Array<T>, M: Int) {
...
fun main() {
    val array = getDoubleArray(1000)
        ex12_SublinearExtraSpace(array, 10)
    ...
    val ex12: (Array<Double>) -> Unit = { ex12_SublinearExtraSpace(it, 10) }
    ...
    doublingTest(20_0000, ex12) { N -> N.toDouble() * N }
}
